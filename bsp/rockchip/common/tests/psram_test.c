...
#define PSRAM_BUFFER_LIMIT  0x10000

static void psram_test_show_usage()
{
    rt_kprintf("1. psram_test write offset size loop\n");
    rt_kprintf("2. psram_test read offset size loop\n");
    rt_kprintf("3. psram_test stress offset size loop\n");
    rt_kprintf("like:\n");
    rt_kprintf("\tpsram_test write 2097152 4096 2000\n");
    rt_kprintf("\tpsram_test read 2097152 4096 2000\n");
    rt_kprintf("\tpsram_test stress 2097152 2097152 5000\n");
}
...
void psram_test(int argc, char **argv)
{
    ...
    psram_device = (struct rk_psram_device *)rt_device_find("psram");
