...
{
    lv_style_copy(&page_common_style, &lv_style_scr);
    page_common_style.body.main_color = LV_COLOR_BLACK;
    page_common_style.body.grad_color = LV_COLOR_BLACK;
    page_common_style.body.padding.top = LABEL_Y_GAP / 2;
    page_common_style.body.padding.bottom = LABEL_Y_GAP / 2;
    page_common_style.text.color = LV_COLOR_WHITE;
    page_common_style.text.font = &lv_font_20;
