...
static rt_err_t rkiot_disp_lvgl_clock_design(struct rkiot_disp_data *iotdisp_data)
{
    ...
    if (1)
    {
        ...
        // set date param to lvgl
        {
            ...
            lv_obj_set_style(iotdisp_data->lv_date, &label_style);
        ...
        // set week param to lvgl
        {
            ...
            lv_obj_set_style(iotdisp_data->lv_week, &label_style);
...
static rt_err_t rkiot_lvgl_iot_design(struct rkiot_disp_data *iotdisp_data)
{
    ...
    if (1)
    {
        ...
        snprintf(iotdisp_data->content_str, sizeof(iotdisp_data->content_str), "请说话......");
#endif
        ...
        lv_obj_set_style(iotdisp_data->lv_content, &label_style);
...
int rkiot_disp_app_init(void)
{
    ...
    thread = rt_thread_create("RkIotDisp", rkiot_disp_thread, RT_NULL, 2048, 5, 10);
